...
class XcrunIosPublisherArguments extends PublisherArguments {
  /// Constructor for `XcrunIosPublisherArguments`.
  XcrunIosPublisherArguments({
  ...
  /// Platform type (e.g., macos, ios, appletvos, visionos).
  final String? type;

  /// Validates the app archive for the App Store.
  final bool validateApp;

  /// Path to the app archive for upload.
  final String? uploadPackage;

  /// Bundle ID of the app.
  final String? bundleId;

  /// Product ID for hosted content.
  final String? productId;

  /// SKU for hosted content.
  final String? sku;

  /// Output format (e.g., xml, json, normal).
  final String? outputFormat;

  factory XcrunIosPublisherArguments.fromArgParser(ArgResults results) {
    return XcrunIosPublisherArguments(
  ...
  factory XcrunIosPublisherArguments.fromJson(Map<String, dynamic> json) {
    return XcrunIosPublisherArguments(
  ...
  static ArgParser parser = ArgParser()
    ..addOption('file', abbr: 'f', help: 'Path to the file to upload')
    ..addOption('username',
  ...
  static defaultConfigs() => XcrunIosPublisherArguments(
        filePath: "",
        username: null,
        password: null,
        apiKey: null,
